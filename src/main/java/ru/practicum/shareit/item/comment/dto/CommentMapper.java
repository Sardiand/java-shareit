...
public class CommentMapper {
    ...
    public static CommentDto toCommentDto(CommentItemDto comment) {
        return new CommentDto(comment.getId(), comment.getText(), comment.getCreated(), comment.getAuthorName());
    }
}
