...
public class ItemUnitTest {
    ...
    void updateItem_whenUserNotAnOwner() {
        User newUser = new User("noName", "noName@user.com");
        newUser.setId(2L);
        ...
        ForbiddenException exp = assertThrows(ForbiddenException.class, () ->
    ...
    @Test
    void getItemById_whenUserIsOwner_withCommentsEmpty() {
        user.setId(99L);
        when(userRepository.existsById(anyLong()))
                .thenReturn(true);
